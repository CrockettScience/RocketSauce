...
import com.base.assets.attributes.AttBoundary;
...
public class EngineBase {
    ...
    public static class Draw extends SortedIteratingSystem {
        ...
        public void processEntity(Entity ent, float deltaTime){
            ...
            ComSprite sprite = BaseComponentMap.SPRITE.get(ent);
            ...
            ComLabel label = BaseComponentMap.LABEL.get(ent);
            if(label != null){
        ...
        private static class ZComparator implements Comparator<Entity> {
            ...
            public int compare(Entity e1, Entity e2) {
                return ((Integer) BaseComponentMap.POSITION.get(e1).getZ()).compareTo((Integer) BaseComponentMap.POSITION.get(e2).getZ());
